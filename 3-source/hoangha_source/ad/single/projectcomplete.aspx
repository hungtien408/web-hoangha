<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="projectcomplete.aspx.cs" Inherits="ad_single_product" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="OriginName" HeaderText="Xuất xứ" SortExpression="OriginName" />
                    ...
                    <asp:GridTemplateColumn DataField="InStock" HeaderText="Đã thi công" SortExpression="InStock" Visible="False">
                        <ItemTemplate>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 204px x 270px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkInStock" runat="server" CssClass="checkbox" Text=" Đã thi công"
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 800px x 770px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="36" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
