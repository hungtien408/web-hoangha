...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void FileImageAlbum_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        ResizeCropImage.ResizeByCondition(targetFolder + newName, 800, 770);
        ResizeCropImage.CreateThumbNailByCondition("~/res/product/album/", "~/res/product/album/thumbs/", newName, 400, 385);
