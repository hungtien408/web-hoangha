<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="projectcompletecategory.aspx.cs" Inherits="ad_single_productcategory" %>
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">
                                Thông Tin Danh Mục Dự Án Đã Thi Công</h3>
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thươc 342px x 537px)</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">
